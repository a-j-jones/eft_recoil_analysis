...
class Selector:
    def __init__(self, video_file: str, best_match=None) -> None:
        """
        ...
        # Draw best match:
        if best_match:
            cv2.rectangle(self.base_frame, best_match[0], best_match[1], (0, 0, 255))
    ...
    def mouse_drawing(self, event: int, x: int, y: int, flags, params) -> None:
        """
